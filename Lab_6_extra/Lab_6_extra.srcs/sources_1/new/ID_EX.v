module ID_EX (clk, reset_n, ifid_instruction, ifid_nextpc, idex_flush, ex_signal, mem_signal, wb_signal, forwardA_data, forwardB_data, sign_extend, idex_instruction, idex_ex_signal, idex_mem_signal, idex_wb_signal, idex_nextpc, idex_forwardA, idex_forwardB, idex_signextend);
    input clk;
    input reset_n;
