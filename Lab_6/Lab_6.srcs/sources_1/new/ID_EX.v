module ID_EX (clk, reset_n, ifid_instruction, ifid_nextpc, ifid_predictpc, idex_flush, ex_signal, mem_signal, wb_signal, regdata1, regdata2, sign_extend, idex_instruction, idex_ex_signal, idex_mem_signal, idex_wb_signal, idex_nextpc, idex_predictpc, idex_regdata1, idex_regdata2, idex_signextend);
    input clk;
    input reset_n;
