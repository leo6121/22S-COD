module MEM_WB (clk, reset_n, memwb_flush, exmem_wb_signal, d_cache_data, exmem_nextpc, exmem_aluout, exmem_regdata1, exmem_writedata, exmem_writeaddr, memwb_wb_signal, memwb_nextpc, memwb_data, memwb_aluout, memwb_regdata1, memwb_writedata, memwb_writeaddr);
    input clk;
    input reset_n;
    input memwb_flush;
    input [5:0] exmem_wb_signal;//{MemtoReg, Regwrite, WWD, HLT, numinst_cond}
    input [15:0] d_cache_data;
