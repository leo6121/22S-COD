...
module Control (clk, reset_n, instruction, ex_signal, mem_signal, wb_signal, use_rs, use_rt);
    ...
    wire [1:0] MemtoReg;//0 for aluout, 1 for memory_data, 2 for pc
    wire [3:0] ALUOp;
    ...
    always @(*) begin
        case (op) 
            ...
            `OPCODE_SWD : control_signal = {2'd0, 2'd0, 1'b0, 1'b0, 1'b1, 2'd0, `OP_ADD, 1'b1, 1'b1, 1'b0, 1'b0, 1'b0, 1'b0, 1'b1};
            `OPCODE_R :
            case (func)
