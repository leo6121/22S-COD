...
module Datapath (clk, reset_n, i_data, i_readM, d_data, ex_signal, mem_signal, wb_signal, use_rs, use_rt, instruction, d_address, i_address, output_port, num_inst, is_halted, d_readM, d_writeM);
    ...
    wire [15:0] forwardA_data, forwardB_data;
    wire branchcond;
    ...
    wire [15:0] memwb_nextpc, memwb_forwardA, memwb_writedata;
    ...
    ID_EX id_ex(
        ...
        .mem_signal(mem_signal),
        .wb_signal(wb_signal),
        .forwardA_data(forwardA_data),
        .forwardB_data(forwardB_data),
    ...
    assign aluinput1 = idex_forwardA;
    assign aluinput2 = (idex_ex_signal[0] == 1'b0) ? idex_forwardB :
                       (idex_ex_signal[0] == 1'b1) ? idex_signextend : idex_forwardB;
    ...
    assign targetaddr = (idex_mem_signal[4]) ? idex_nextpc + idex_signextend ://branch
                        ...
                        (idex_mem_signal[3]) ? idex_forwardA : idex_nextpc;//jpr,jrl
    ...
    assign writedata = (exmem_wb_signal[5:4] == 2'd0) ? exmem_aluout : 
                       (exmem_wb_signal[5:4] == 2'd1) ? d_data :
                       (exmem_wb_signal[5:4] == 2'd2) ? exmem_nextpc : exmem_aluout;
