...
module Datapath (clk, reset_n, i_data, d_data, ex_signal, mem_signal, wb_signal, use_rs, use_rt, BR, instruction, d_address, i_address, output_port, num_inst, is_halted, i_readM, d_readM, d_writeM, BG);
    input clk;
    input reset_n;
    inout [63:0] i_data;
    inout [63:0] d_data;
