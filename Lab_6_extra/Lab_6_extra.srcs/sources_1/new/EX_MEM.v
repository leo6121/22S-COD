module EX_MEM (clk, reset_n, exmem_flush, idex_mem_signal, idex_wb_signal, idex_nextpc, idex_predictpc, targetaddr, branchcond, aluout, idex_forwardA, idex_forwardB, writeaddr, exmem_mem_signal, exmem_wb_signal, exmem_nextpc, exmem_predictpc, exmem_targetaddr, exmem_branchcond, exmem_aluout, exmem_forwardA, exmem_writedata, exmem_writeaddr);
    input clk;
    input reset_n;
    input exmem_flush;
