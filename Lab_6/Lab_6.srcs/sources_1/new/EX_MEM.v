module EX_MEM (clk, reset_n, exmem_flush, idex_mem_signal, idex_wb_signal, idex_nextpc, targetaddr, branchcond, aluout, idex_regdata1, idex_regdata2, writeaddr, exmem_mem_signal, exmem_wb_signal, exmem_nextpc, exmem_targetaddr, exmem_branchcond, exmem_aluout, exmem_regdata1, exmem_writedata, exmem_writeaddr);
    input clk;
    input reset_n;
    input exmem_flush;
