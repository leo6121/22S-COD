module Hazard (ifid_instruction, idex_instruction, use_rs, use_rt, idex_ex_signal, idex_wb_signal, exmem_branchcond, exmem_mem_signal, exmem_wb_signal, exmem_writeaddr, exmem_targetaddr, exmem_predictpc, exmem_nextpc, memwb_wb_signal, memwb_writeaddr, pc_stall, ifid_stall, ifid_flush, idex_flush, exmem_flush, correctpc);
    ...
    always @(*) begin
        ...
        //dependency on rs, rt
            ...
            if(((ifid_rs == idex_writeaddr && use_rs) || (ifid_rt == idex_writeaddr && use_rt)) && idex_wb_signal[3]) begin
                pc_stall = 1;
                ifid_stall = 1;
                ifid_flush = 0;
                idex_flush = 1;
            ...
            else if(((ifid_rs == exmem_writeaddr && use_rs) || (ifid_rt == exmem_writeaddr && use_rt)) && exmem_wb_signal[3]) begin
                pc_stall = 1;
                ifid_stall = 1;
                ifid_flush = 0;
                idex_flush = 1;
            ...
            else if(((ifid_rs == memwb_writeaddr && use_rs) || (ifid_rt == memwb_writeaddr && use_rt)) && memwb_wb_signal[3]) begin
                pc_stall = 1;
                ifid_stall = 1;
                ifid_flush = 0;
                idex_flush = 1;
